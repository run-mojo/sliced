...
//unsigned char *REDISMODULE_API_FUNC(lpNew)(void);
//void REDISMODULE_API_FUNC(lpFree)(unsigned char *lp);
//uint32_t REDISMODULE_API_FUNC(lpLength)(unsigned char *lp);
//
//rax *REDISMODULE_API_FUNC(raxNew)(void);
//void REDISMODULE_API_FUNC(raxFree)(rax *rax);
